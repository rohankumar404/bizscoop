        ...
        <div class="contact-grid" style="max-width:1100px;margin:0 auto;display:grid;grid-template-columns:1fr 1.5fr;gap:60px;">
            ...
            <div>
                ...
                <div style="margin-top:60px;display:flex;gap:15px;">
                    ...
                    <!-- LinkedIn -->
                    <a href="https://www.linkedin.com/company/bizscoop-mena/"
                    target="_blank"
                    style="width:40px;height:40px;background:#111;color:#fff;display:flex;align-items:center;justify-content:center;text-decoration:none;border-radius:4px;transition:all 0.3s;"
                    ...
                    <!-- Instagram -->
                    <a href="https://www.instagram.com/bizscoopmena?igsh=MWNqY3F6NWdoZTA0ZA=="
                    target="_blank"
                    style="width:40px;height:40px;background:#111;color:#fff;display:flex;align-items:center;justify-content:center;text-decoration:none;border-radius:4px;transition:all 0.3s;"
                    onmouseover="this.style.background='#000'"
                    onmouseout="this.style.background='#111'">
                    ...
                    <!-- Facebook -->
                    <a href="https://www.facebook.com/share/1Ay66dEyNf/"
                    target="_blank"
                    style="width:40px;height:40px;background:#111;color:#fff;display:flex;align-items:center;justify-content:center;text-decoration:none;border-radius:4px;transition:all 0.3s;"
                    onmouseover="this.style.background='#000'"
                    onmouseout="this.style.background='#111'">
                    ...
                    <!-- Threads -->
                    <a href="https://www.threads.com/@bizscoopmena"
                    target="_blank"
                    style="width:40px;height:40px;background:#111;color:#fff;display:flex;align-items:center;justify-content:center;text-decoration:none;border-radius:4px;transition:all 0.3s;"
                    onmouseover="this.style.background='#000'"
                    onmouseout="this.style.background='#111'">
