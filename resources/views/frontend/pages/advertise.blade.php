        ...
        <div class="adv-grid-4" style="display:grid;grid-template-columns:repeat(4, 1fr);gap:20px;margin-bottom:80px;text-align:center;">
            ...
            @foreach($stats as $s)
                <div style="background:#fff;padding:30px;border-radius:12px;box-shadow:0 10px 30px rgba(0,0,0,0.05);border:1px solid #f0f0f0;">
                    <div class="adv-stat-number" style="font-size:36px;font-weight:900;color:#000;margin-bottom:5px;">{{ $s[0] }}</div>
                    ...
                    <div style="display:flex;flex-direction:column;gap:25px;">
                        ...
                        @foreach($products as $p)
                            <div style="display:flex;gap:20px;">
                                <div style="width:24px;height:24px;background:#000;border-radius:50%;display:flex;align-items:center;justify-content:center;flex-shrink:0;margin-top:4px;">
                        ...
                        <div>
                            ...
                            <form @submit.prevent="submit" style="display:flex;flex-direction:column;gap:15px;">
                                ...
                                <div>
                                    ...
                                    <template x-if="errors.company"><span x-text="errors.company[0]" style="color:#000;font-size:10px;font-weight:bold;margin-top:5px;display:block;"></span></template>
                                </div>
                                
                                <button type="submit" :disabled="loading" style="background:#000;color:#fff;padding:15px;font-weight:900;text-transform:uppercase;font-size:13px;border:none;border-radius:4px;cursor:pointer;transition:all 0.3s;display:flex;align-items:center;justify-content:center;gap:10px;" onmouseover="this.style.background='#333'" onmouseout="this.style.background='#000'">
