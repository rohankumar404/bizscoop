<x-frontend-layout>
    ...
    {{-- Cinematic Header --}}
    <div style="background:linear-gradient(135deg, #e60000 0%, #111 100%);padding:100px 0;position:relative;overflow:hidden;">
        ...
        <div class="wrap text-center">
            <h1 style="font-family:'Merriweather',serif;font-size:64px;font-weight:900;color:#fff;margin:0;letter-spacing:-0.04em;">Advertise With Us</h1>
    ...
    <div class="wrap" style="padding:60px 0;">
        ...
        {{-- Audience Stats --}}
        <div style="display:grid;grid-template-columns:repeat(4, 1fr);gap:20px;margin-bottom:80px;text-align:center;">
            @php
                $stats = [
            ...
            @foreach($stats as $s)
                <div style="background:#fff;padding:30px;border-radius:12px;box-shadow:0 10px 30px rgba(0,0,0,0.05);border:1px solid #f0f0f0;">
                    <div style="font-size:36px;font-weight:900;color:#e60000;margin-bottom:5px;">{{ $s[0] }}</div>
        ...
        <div style="max-width:1000px;margin:0 auto;">
            <div style="display:grid;grid-template-columns:1.5fr 1fr;gap:60px;align-items:start;">
                ...
                <div style="background:#f9f9f9;padding:40px;border-radius:12px;border:1px solid #eee;position:sticky;top:100px;">
                    ...
                    <form style="display:flex;flex-direction:column;gap:15px;">
                        <input type="text" placeholder="Full Name" style="width:100%;padding:12px;border:1px solid #ddd;border-radius:4px;outline:none;font-size:14px;">
                        <input type="email" placeholder="Work Email" style="width:100%;padding:12px;border:1px solid #ddd;border-radius:4px;outline:none;font-size:14px;">
                        <input type="text" placeholder="Company Name" style="width:100%;padding:12px;border:1px solid #ddd;border-radius:4px;outline:none;font-size:14px;">
                        <button type="submit" style="background:#e60000;color:#fff;padding:15px;font-weight:900;text-transform:uppercase;font-size:13px;border:none;border-radius:4px;cursor:pointer;transition:all 0.3s;" onmouseover="this.style.background='#c00'" onmouseout="this.style.background='#e60000'">Send Request</button>
                    </form>
