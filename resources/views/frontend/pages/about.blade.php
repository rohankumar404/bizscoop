<x-frontend-layout>
    ...
    <div class="wrap" style="padding:60px 0;">
        <div class="about-box" style="max-width:900px;margin:0 auto;background:#fff;padding:60px;border-radius:12px;box-shadow:0 20px 60px rgba(0,0,0,0.05);border:1px solid #f0f0f0;">
            ...
            <div class="about-grid-2" style="display:grid;grid-template-columns:1fr 1fr;gap:40px;margin-bottom:60px;">
                <div style="background:#f9f9f9;padding:30px;border-radius:8px;border-left:4px solid #000;">
            ...
            <section style="margin-bottom:50px;">
                <h2 style="font-family:'Merriweather',serif;font-size:32px;font-weight:900;color:#111;margin-bottom:24px;border-bottom:3px solid #000;display:inline-block;padding-bottom:8px;">What We Cover</h2>
                <div class="about-grid-3" style="display:grid;grid-template-columns:repeat(3, 1fr);gap:20px;">
